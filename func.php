...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>تسجيل خروج</a>
      </li>
       <li class="nav-item">
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">موعد</a>
    ...
    <div class="tab-content" id="nav-tabContent">
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="appointment.php">
                <div class="row">
                  ...
                  <div class="col-md-4"><label>طبيب:</label></div>
                  <div class="col-md-8">
                  ...
                  <div class="col-md-4"><label>دفع:</label></div>
                  <div class="col-md-8">
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="func.php">
          ...
          <br>
          <input type="submit" name="doc_sub" value="أضف دكتور" class="btn btn-primary">
        </form>
      </div>
