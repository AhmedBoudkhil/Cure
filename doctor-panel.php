...
if(isset($_GET['cancel']))
  {
    ...
    if($query)
    {
      echo "<script>alert('Votre rendez-vous a été annulé avec succès');</script>";
    }
  }
...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      ...
      <img src="images/1.png" alt="Cure Logo" class="navbar-logo" style="width: 50px; height: auto; right: 20px;">
...
.text-primary {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="logout1.php"><i class="fa fa-sign-out" aria-hidden="true"></i>déconnexion</a>
      </li>
       <li class="nav-item">
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Bienvenue &nbsp<?php echo $_SESSION['dname'] ?>  </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:89.7%;margin-top: 1%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list">Tableau de bord</a>
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Les rendez-vous</a>
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Liste des ordonnances</a>
               ...
               <div class="col-sm-4" style="left: -30%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 2%;">Afficher les rendez-vous</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: -30%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 2%;"> Ordonnances</h4>
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                              ...
                              title="Annuler rendez-vous" tooltip-placement="top" tooltip="Remove"><button class="btn btn-danger">Annuler</button></a>
	                        <?php } else {
                        ...
                        <button class="btn btn-success">Prescrit au patient</button></a>
                        <?php } else {
...
$con=mysqli_connect("localhost","root","","HMSEG");
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  <div class="col-md-4"><label>Nom du médecin :</label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="doctor" required></div><br><br>
                  <div class="col-md-4"><label>Mot de passe:</label></div>
                  <div class="col-md-8"><input type="password" class="form-control"  name="dpassword" required></div><br><br>
                  <div class="col-md-4"><label>Email:</label></div>
                  <div class="col-md-8"><input type="email"  class="form-control" name="demail" required></div><br><br>
                  <div class="col-md-4"><label>Frais de consultation :</label></div>
                  <div class="col-md-8"><input type="text" class="form-control"  name="docFees" required></div><br><br>
                </div>
          <input type="submit" name="docsub" value="Ajouter un médecin" class="btn btn-primary">
        </form>
      </div>
